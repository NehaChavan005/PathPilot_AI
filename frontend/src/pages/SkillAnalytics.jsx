...
const SkillAnalytics = () => {
  const kpiStats = [
    { label: "Total Learning Hours", value: "142h", trend: "+12h this week", icon: kpiIcons.hours },
    { label: "Skills Mastered", value: "14", trend: "Top 15% of learners", icon: kpiIcons.skills },
    { label: "Assessments Passed", value: "8", trend: "2 pending review", icon: kpiIcons.assessments },
    { label: "Global Rank", value: "84th", trend: "Percentile", icon: kpiIcons.rank }
  ];
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen font-sans">
      ...
      <div className="mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <p className="text-sm font-medium text-slate-500 mt-2 max-w-xl">
          Comprehensive breakdown of your AI/ML capability matrix and learning velocity.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: '300ms' }}>
        ...
        <div className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-green-200 transition-colors">
          ...
          <div className="space-y-4">
            {['Python & Pandas', 'Data Transformation (Power Query)', 'Flask & Streamlit UI'].map((item, i) => (
        ...
        <div className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-orange-200 transition-colors">
          ...
          <div className="space-y-4">
            {['Deep Learning (CNNs)', 'Salesforce Data Cloud Architecture', 'Advanced MLOps'].map((item, i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-orange-50/50 border border-orange-100 rounded-xl">
                ...
                <button className="text-[10px] font-bold bg-white border border-slate-200 px-3 py-1.5 rounded-lg text-slate-600 hover:text-indigo-600 transition-colors shadow-sm">
                  Review
                </button>
              </div>
            ))}
